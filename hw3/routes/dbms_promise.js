...
var host = "34.82.88.152";    //from GCloud instance (change to match your db)
var database = "amazing-math-413705:us-west1:cheesecakedb";  //database name
var user = "root";         //username (change to match your db)
var password = "8igY@pperfum\eDalle$";  //password (change to match your db, yes this is very poor practice)
